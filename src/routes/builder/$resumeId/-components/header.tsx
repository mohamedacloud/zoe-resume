...
export function BuilderHeader() {
	...
	return (
		<>
				...
				<div className="flex items-center gap-1">
					<TooltipProvider>
						...
						<Tooltip>
							...
							<TooltipContent>
								<p>{typographySectionItem.title}</p>
							</TooltipContent>
						</Tooltip>

						{regularSections.map((btn) => (
							<Tooltip key={btn.section}>
								<TooltipTrigger asChild>
									<Button
										size="icon"
										variant="ghost"
			...
			{/* Cover Letter Dialog - Side Panel on Right */}
			{openSection === "notes" && (
